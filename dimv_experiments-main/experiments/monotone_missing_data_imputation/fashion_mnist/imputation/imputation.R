...
## -----------------------------------------------------------------------------
# X_train_path = '../../../data/fashion_mnist/imputed/v1/threshold_10_deletedWidthHeightPc_6060_noImagePc_50/X_train_normed.csv.gz'
# X_test_path = '../../../data/fashion_mnist/imputed/v1/threshold_10_deletedWidthHeightPc_6060_noImagePc_50/X_test_normed.csv.gz'
# tr = read.table(X_train_path, sep=' ', header=TRUE)
# te = read.table(X_test_path, sep=' ', header=TRUE)
