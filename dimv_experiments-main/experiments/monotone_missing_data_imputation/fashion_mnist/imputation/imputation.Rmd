...
imputationPipeline<- function(
  ...
  # imputed data
  write.table(result_impDi$train, file.path(sub_path, 'train_knn.csv.gz'), row.names=FALSE)
  write.table(result_impDi$test, file.path(sub_path, 'test_knn.csv.gz'), row.names=FALSE)
