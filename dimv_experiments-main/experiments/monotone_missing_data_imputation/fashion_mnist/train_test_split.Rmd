...
imputationPipeline<- function(
  ...
  write.table(missing.X_train_mean, file.path(sub_path, "X_train_mean.csv.gz"), row.names=FALSE)
  write.table(missing.X_train_sd, file.path(sub_path, "X_train_sd.csv.gz"), row.names=FALSE)
  # imputed data
